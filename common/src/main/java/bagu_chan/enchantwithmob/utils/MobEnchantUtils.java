...
public class MobEnchantUtils {
    ...
    public static MobEnchant getEnchantFromNBT(@Nullable CompoundTag tag) {
        if (tag != null && EWRegistries.MOB_ENCHANT_TYPE.containsKey(ResourceLocation.tryParse(tag.getString(TAG_MOBENCHANT)))) {
            return EWRegistries.MOB_ENCHANT_TYPE.get(ResourceLocation.tryParse(tag.getString(TAG_MOBENCHANT)));
        } else {
            return null;
        }
    }
    ...
    public static MobEnchant getEnchantFromString(@Nullable String id) {
        if (id != null && EWRegistries.MOB_ENCHANT_TYPE.containsKey(ResourceLocation.tryParse(id))) {
            return EWRegistries.MOB_ENCHANT_TYPE.get(ResourceLocation.tryParse(id));
        } else {
            return null;
        }
    }
    ...
    public static MobEnchant getEnchantFromResourceLocation(@Nullable ResourceLocation id) {
        if (id != null && EWRegistries.MOB_ENCHANT_TYPE.containsKey(id)) {
            return EWRegistries.MOB_ENCHANT_TYPE.get(id);
        } else {
            return null;
        }
    }
    ...
    public static void setEnchantments(Map<MobEnchant, Integer> enchMap, ItemStack stack) {
        ...
        for (Map.Entry<MobEnchant, Integer> entry : enchMap.entrySet()) {
            ...
            if (enchantment != null) {
                ...
                compoundnbt.putString(TAG_MOBENCHANT, String.valueOf((Object) EWRegistries.MOB_ENCHANT_TYPE.getKey(enchantment)));
    ...
    public static void addMobEnchantToItemStack(ItemStack itemIn, MobEnchant mobenchant, int level) {
        ...
        boolean flag = true;
        ResourceLocation resourcelocation = EWRegistries.MOB_ENCHANT_TYPE.getKey(mobenchant);
    ...
    public static List<MobEnchantmentData> makeMobEnchantmentDatas(int p_185291_0_, boolean allowTresure, boolean allowCursed) {
        ...
        for (MobEnchant enchantment : EWRegistries.MOB_ENCHANT_TYPE) {
