...
import com.infamousmisadventures.infamousexample.InfamousExample;
...
public interface IRegistrar {
    ...
    /**
     * Main method for this service interface, called in {@link InfamousExample} in order to load it and its loader-specific implementations accordingly. Should NOT be called anywhere else!
     */
    void setupRegistrar();
